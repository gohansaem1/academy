...
#### 관리자 대시보드 및 경영자료 📊 (신규 개발 예정)
- **대시보드 개요**
  - 핵심 지표 카드 (전체 학생 수, 강사 수, 수업 수, 월별 수익 등)
  - 최근 활동 내역
  - 빠른 액세스 메뉴
...
### Phase 10: 관리자 대시보드 및 경영자료 📊 ✅ (90% 완료)
- [x] 관리자 대시보드 메인 페이지 개발 (`/admin/dashboard`)
- [x] 핵심 지표 카드 컴포넌트 개발
- [x] 수강생 현황 통계 페이지 (`/admin/statistics/students`)
  - [x] 전체 학생 수 및 증감 추이
  - [x] 신규/이탈 학생 통계
  - [x] 학생 분포 분석 (과목별)
- [x] 수업 현황 통계 페이지 (`/admin/statistics/courses`)
  - [x] 수업 수 및 증감 추이
  - [x] 수업별 수강 인원 현황
  - [x] 과목별/요일별/시간대별 수업 분포
- [x] 수강료 수납 통계 페이지 (`/admin/statistics/payments`)
  - [x] 월별/연도별 수납 현황
  - [x] 수업별 수납 통계
  - [x] 미납 학생 현황
  - [x] 결제 방법별 통계
- [x] 출석률 통계 페이지 (`/admin/statistics/attendance`)
  - [x] 전체 출석률 통계
  - [x] 수업별/학생별 출석률
  - [x] 출석 상태별 통계
- [x] 강사별 통계 페이지 (`/admin/statistics/instructors`)
  - [x] 강사별 담당 수업 및 수강생 수
  - [x] 강사별 출석률 및 학습일지 작성 현황
- [x] 매출 분석 페이지 (`/admin/statistics/revenue`)
  - [x] 월별/연도별 매출 추이
  - [x] 수업별 매출 기여도
  - [x] 예상 vs 실제 매출 비교
- [x] 경영 지표 대시보드 (`/admin/statistics/kpi`)
  - [x] 학생당 평균 수강료
  - [x] 수업당 평균 수강생 수
  - [x] 운영 효율성 지표
- [ ] 통계 데이터 시각화 (차트 라이브러리 연동) - 향후 개선
  - [ ] 라인 차트 (추이 분석)
  - [ ] 바 차트 (비교 분석)
  - [ ] 파이 차트 (비율 분석)
- [x] 통계 데이터 필터링 기능 (기간 선택)
- [ ] 통계 데이터 엑셀/PDF 내보내기 기능 - 향후 개선
