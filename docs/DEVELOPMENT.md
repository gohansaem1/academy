...
### Phase 10: 관리자 대시보드 및 경영자료 📊 (신규 개발 예정)
- [ ] 관리자 대시보드 메인 페이지 개발 (`/admin/dashboard`)
- [ ] 핵심 지표 카드 컴포넌트 개발
- [ ] 수강생 현황 통계 페이지 (`/admin/statistics/students`)
  - [ ] 전체 학생 수 및 증감 추이
  - [ ] 신규/이탈 학생 통계
  - [ ] 학생 분포 분석 (과목별, 연령대별)
- [ ] 수업 현황 통계 페이지 (`/admin/statistics/courses`)
  - [ ] 수업 수 및 증감 추이
  - [ ] 수업별 수강 인원 현황
  - [ ] 과목별/요일별 수업 분포
- [ ] 수강료 수납 통계 페이지 (`/admin/statistics/payments`)
  - [ ] 월별/연도별 수납 현황
  - [ ] 수업별 수납 통계
  - [ ] 미납 학생 현황
  - [ ] 결제 방법별 통계
- [ ] 출석률 통계 페이지 (`/admin/statistics/attendance`)
  - [ ] 전체 출석률 통계
  - [ ] 수업별/학생별 출석률
  - [ ] 출석 상태별 통계
- [ ] 강사별 통계 페이지 (`/admin/statistics/instructors`)
  - [ ] 강사별 담당 수업 및 수강생 수
  - [ ] 강사별 출석률 및 학습일지 작성 현황
- [ ] 매출 분석 페이지 (`/admin/statistics/revenue`)
  - [ ] 월별/연도별 매출 추이
  - [ ] 수업별 매출 기여도
  - [ ] 예상 vs 실제 매출 비교
- [ ] 경영 지표 대시보드 (`/admin/statistics/kpi`)
  - [ ] 학생당 평균 수강료
  - [ ] 수업당 평균 수강생 수
  - [ ] 운영 효율성 지표
- [ ] 통계 데이터 시각화 (차트 라이브러리 연동)
  - [ ] 라인 차트 (추이 분석)
  - [ ] 바 차트 (비교 분석)
  - [ ] 파이 차트 (비율 분석)
  - [ ] 테이블 (상세 데이터)
- [ ] 통계 데이터 필터링 기능 (기간, 수업, 강사 등)
- [ ] 통계 데이터 엑셀/PDF 내보내기 기능
